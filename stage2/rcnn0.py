...
#testa_path = '/search/work/testa.tsv' # testa set
...
train_feature_p_path = '/search/work/train_fea_p.npy' # train passage word feature
valid_feature_p_path = '/search/work/valid_fea_p.npy' # validation passage word feature
#test_feature_p_path = '/search/work/testa_fea_p.npy' # test passage word feature
train_feature_q_path = '/search/work/train_fea_q.npy' # train passage word feature
valid_feature_q_path = '/search/work/valid_fea_q.npy' # validation passage word feature
#test_feature_q_path = '/search/work/testa_fea_q.npy' # test passage word feature
...
#testa = pd.read_csv(testa_path, sep='\t', header=0)
...
#testa_feature_p = np.load(testa_feature_p_path)
#testa_feature_q = np.load(testa_feature_q_path)
...
#tea_p = tokenizer.texts_to_sequences(testa['passage'])
#tea_q = tokenizer.texts_to_sequences(testa['query'])
...
#testa_p = pad_sequences(tea_p, maxlen=maxlen_p)
#testa_q = pad_sequences(tea_q, maxlen=maxlen_q, padding='post', truncating='post')
...
cp = ModelCheckpoint(filepath='/search/work/output/my5.h5', monitor='val_binary_accuracy', save_best_only=True, save_weights_only=True)
...
model.load_weights('/search/work/output/my5.h5')
