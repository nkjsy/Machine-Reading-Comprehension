...
train1(model, '/search/work/output/my1.h5', 5)
# load best weights
model.load_weights('/search/work/output/my1.h5')
predict(model, '/search/work/output/test1_long.csv')
print ('match prediction saved')

# BIDAF
K.clear_session()
model = BIDAF6.single_model(embedding_matrix, fasttext_matrix)
train1(model, '/search/work/output/my2.h5', 5)
# load best weights
model.load_weights('/search/work/output/my2.h5')
predict(model, '/search/work/output/test2_long.csv')
